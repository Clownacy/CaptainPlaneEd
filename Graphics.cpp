...
{
    uint32_t color = SDL_MapRGB(MainScreen->surface->format, MainScreen->background_colour.red, MainScreen->background_colour.green, MainScreen->background_colour.blue);
    SDL_Rect RectTemp;
    RectTemp.x = 0;
    RectTemp.y = 0;
